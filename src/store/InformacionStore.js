...
const useInformacionStore = create((set)=>({
    ...
    addInformacion: async(informacion)=>{
        try {
            const response = await axios.post('https://bakend-bradatec.onrender.com/informacion',informacion)
    ...
    fetchInformacion: async()=>{
        try {
            const response = await axios.get('https://bakend-bradatec.onrender.com/informacion')
    ...
    deleteInformacion: async(ID_Informacion)=>{
        try {
            const response = await axios.delete(`https://bakend-bradatec.onrender.com/informacion/${ID_Informacion}`)
    ...
    updateInformacion: async (ID_Informacion, updatedData) => {
        try { 
            const response = await axios.put(`https://bakend-bradatec.onrender.com/informacion/${ID_Informacion}`, updatedData)
