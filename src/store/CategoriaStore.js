...
const useCategoriaStore = create((set, get) => ({
    ...
    addCategoria: async (categoria) => {
        try {
            ...
            const response = await axios.post('https://bakend-bradatec.onrender.com/Categorias', categoria);
    ...
    fetchCategoria: async () => {
        ...
        try {
            ...
            const response = await axios.get('https://bakend-bradatec.onrender.com/Categorias');
    ...
    deleteCategoria: async(ID_Categoria) => {
        try {
            await axios.delete(`https://bakend-bradatec.onrender.com/Categorias/${ID_Categoria}`);
            set((state) => ({
    ...
    updateCategoria: async (ID_Categoria, updatedData) => {
        try {
            const response = await axios.put(`https://bakend-bradatec.onrender.com/Categorias/${ID_Categoria}`, updatedData);
