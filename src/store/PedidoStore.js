...
const usePedidoStore = create((set)=>({
    ...
    addPedido: async (pedido) => {
      try {
        const response = await axios.post('https://bakend-bradatec.onrender.com/pedidos', pedido, {
    ...
    fetchPedido: async () => {
      try {
        const response = await axios.get('https://bakend-bradatec.onrender.com/pedidos', {
    ...
    deletePedido: async(ID_Pedido)=>{
        try {
            const response = await axios.delete(`https://bakend-bradatec.onrender.com/pedidos/${ID_Pedido}`)
    ...
    updatePedido: async (ID_Pedido, updatedData) => {
        try {  // Realiza una solicitud PUT para actualizar el estudiante en el servidor.
            const response = await axios.put(`https://bakend-bradatec.onrender.com/pedidos/${ID_Pedido}`, updatedData)
