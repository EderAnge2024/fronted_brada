...
const useHistorialEstadoStore = create((set)=>({
    ...
    addHistorialEstado: async(historialEstado)=>{
        try {
            ...
            const response = await axios.post('https://bakend-bradatec.onrender.com/historialEstado', dataToSend)
    ...
    fetchHistorialEstado: async()=>{
        try {
            const response = await axios.get('https://bakend-bradatec.onrender.com/historialEstado')
    ...
    deleteHistorialEstado: async(ID_Historial)=>{
        try {
            const response = await axios.delete(`https://bakend-bradatec.onrender.com/historialEstado/${ID_Historial}`)
    ...
    updateHistorialEstado: async (ID_Historial, updatedData) => {
        try {  
            const response = await axios.put(`https://bakend-bradatec.onrender.com/historialEstado/${ID_Historial}`, updatedData)
