...
const useAdministradorStore = create((set)=>({
    ...
    addAdministrador: async(administrador)=>{
        try {
            const response = await axios.post('https://bakend-bradatec.onrender.com/administrador',administrador)
    ...
    fetchAdministrador: async()=>{
        try {
            const response = await axios.get('https://bakend-bradatec.onrender.com/administrador')
    ...
    deleteAdministrador: async(ID_Administrador)=>{
        try {
            const response = await axios.delete(`https://bakend-bradatec.onrender.com/administrador/${ID_Administrador}`)
    ...
    updateAdministrador: async (ID_Administrador, updatedData) => {
        try { 
            const response = await axios.put(`https://bakend-bradatec.onrender.com/administrador/${ID_Administrador}`, updatedData)
