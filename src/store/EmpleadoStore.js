...
const useEmpleadoStore = create((set)=>({
    ...
    addEmpleado: async(empleado)=>{
        try {
            const response = await axios.post('https://bakend-bradatec.onrender.com/empleado',empleado)
    ...
    fetchEmpleado: async()=>{
        try {
            const response = await axios.get('https://bakend-bradatec.onrender.com/empleado')
    ...
    deleteEmpleado: async(ID_Empleado)=>{
        try {
            const response = await axios.delete(`https://bakend-bradatec.onrender.com/empleado/${ID_Empleado}`)
    ...
    updateEmpleado: async (ID_Empleado, updatedData) => {
        try {  // Realiza una solicitud PUT para actualizar el estudiante en el servidor.
            const response = await axios.put(`https://bakend-bradatec.onrender.com/empleado/${ID_Empleado}`, updatedData)
