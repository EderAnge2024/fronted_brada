...
const useDashboardStore = create((set, get) => ({
    ...
    fetchTotales: async () => {
        try {
            const [pedidosRes,historialEstadoRes, clientesRes, productosRes, facturasRes] = await Promise.all([
                ...
                axios.get('https://bakend-bradatec.onrender.com/pedidos'),
                axios.get('https://bakend-bradatec.onrender.com/historialEstado'),
                axios.get('https://bakend-bradatec.onrender.com/clientes'),
                axios.get('https://bakend-bradatec.onrender.com/productos'),
                axios.get('https://bakend-bradatec.onrender.com/factura')
            ]);
    ...
    fetchCategoriasMasVendidas: async () => {
        try {
            const [categoriasRes, productosRes, detallesRes] = await Promise.all([
                axios.get('https://bakend-bradatec.onrender.com/Categorias'),
                axios.get('https://bakend-bradatec.onrender.com/productos'),
                axios.get('https://bakend-bradatec.onrender.com/detallePedido')
            ]);
    ...
    try {
        const [pedidosRes, estadosRes, historialRes] = await Promise.all([
            axios.get('https://bakend-bradatec.onrender.com/pedidos'),
            axios.get('https://bakend-bradatec.onrender.com/estadoPedido'),
            axios.get('https://bakend-bradatec.onrender.com/historialEstado')
        ]);
