...
const useClienteStore = create((set, get) => ({
  ...
  deleteCliente: async(ID_Cliente)=>{
        try {
            const response = await axios.delete(`https://bakend-bradatec.onrender.com/clientes/${ID_Cliente}`)
  ...
  addCliente: async (cliente) => {
    set({ loading: true })
    try {
      const response = await axios.post('https://bakend-bradatec.onrender.com/clientes', cliente, {
        withCredentials: true
      })
  ...
  loginCliente: async (loginData) => {
    set({ loading: true })
    try {
      const response = await axios.post('https://bakend-bradatec.onrender.com/clientes/login', loginData, {
        withCredentials: true,
...
verificarToken: async () => {
  ...
  updateCliente: async (ID_Cliente, updatedData) => {
    set({ loading: true })
    try {
      const response = await axios.put(`https://bakend-bradatec.onrender.com/clientes/${ID_Cliente}`, updatedData, {
        withCredentials: true
      })
  ...
  logout: async () => {
    ...
    try {
      ...
      await axios.post('https://bakend-bradatec.onrender.com/clientes/logout', {}, {
        withCredentials: true
      })
    } catch (error) {
