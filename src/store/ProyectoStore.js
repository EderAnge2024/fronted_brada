...
const useProyectoStore = create((set)=>({
    ...
    addProyecto: async(proyecto)=>{
        try {
            const response = await axios.post('https://bakend-bradatec.onrender.com/proyecto',proyecto)
    ...
    fetchProyecto: async()=>{
        try {
            const response = await axios.get('https://bakend-bradatec.onrender.com/proyecto')
    ...
    deleteProyecto: async(ID_Proyectos)=>{
        try {
            const response = await axios.delete(`https://bakend-bradatec.onrender.com/proyecto/${ID_Proyectos}`)
    ...
    updateProyecto: async (ID_Proyectos, updatedData) => {
        try { 
            const response = await axios.put(`https://bakend-bradatec.onrender.com/proyecto/${ID_Proyectos}`, updatedData)
