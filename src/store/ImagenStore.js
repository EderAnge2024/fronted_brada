...
const useImagenStore = create((set, get) => ({
    ...
    addImagen: async (imagen) => {
        try {
            const response = await axios.post('https://bakend-bradatec.onrender.com/imagen', imagen)
    ...
    fetchImagen: async () => {
        try {
            const response = await axios.get('https://bakend-bradatec.onrender.com/imagen')
    ...
    deleteImagen: async (ID_Imagen) => {
        try {
            const response = await axios.delete(`https://bakend-bradatec.onrender.com/imagen/${ID_Imagen}`)
    ...
    updateImagen: async (ID_Imagen, updatedData) => {
        try {
            ...
            const response = await axios.put(`https://bakend-bradatec.onrender.com/imagen/${ID_Imagen}`, updatedData)
    ...
    setLogoPrincipal: async (logoId) => {
        try {
            ...
            const updatePromises = logos.map(async (logo) => {
                ...
                return axios.put(`https://bakend-bradatec.onrender.com/imagen/${logo.ID_Imagen}`, {
                    ...logo,
